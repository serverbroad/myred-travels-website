...
const actions = {
  // Channel metadata only — no message content.
  find_channels: {
    url: "https://app-dxkz3ebw9eyp-api-connect-slack-find-channels.gateway.appmedo.com/",
    callers: "public",
  },
  // Free-text search across the workspace; there is no target to pin.
  search_messages: {
    url: "https://app-dxkz3ebw9eyp-api-connect-slack-search-messages.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_channel_history: {
    url: "https://app-dxkz3ebw9eyp-api-connect-slack-get-channel-history.gateway.appmedo.com/",
    callers: "authenticated",
  },
  send_message: {
    url: "https://app-dxkz3ebw9eyp-api-connect-slack-send-message.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
...
```ts
const connectionEnv = "MEDO_CONNECT_SLACK";
